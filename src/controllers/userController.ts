...
export const createUser = async (req: Request, res: Response, next: NextFunction) => {
    ...
    let imageUrl : string = req.body.imageUrl || "https://i.imgur.com/h9m0E58.jpg";
    ...
    try {
        ...
        // Create the user
        const user: Users = await Users.create({firstName, lastName, email, password, phone, DOB, imageUrl, role});
